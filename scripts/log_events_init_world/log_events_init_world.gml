...
function log_events_init_world(){
	...
	log_event(LOGEVENT.INFO_PARAMETERS, "Date time "			+date_date_string(date_current_datetime()) +" "+date_time_string(date_current_datetime())); 
	...
	log_event(LOGEVENT.INFO_PARAMETERS, "Radiation"				+ string(controller.world.radiation));
