...
function log_data_init_world(){
	...
	//show_debug_message("CLIMATE_TILE_MULTIPLIER:      "+ string( CLIMATE_TILE_MULTIPLIER));
	...
	show_debug_message("1 sim year =  "+string(controller.time.years_to_sim_steps(1))+" sim step");
	show_debug_message("1 sim step =  "+string(controller.time.sim_steps_to_years(1))+" year");
	show_debug_message("1 sim kg =    "+string(1/units_to_kg(1))+" unit");
	show_debug_message("1 unit =      "  +string(units_to_kg(1))+" kg");
	show_debug_message("1 sim kg/year   = "  +string(controller.time.kg_per_year_to_units_per_sim_step(1)*room_speed)+" unit/second");
	show_debug_message("1 sim kg/year   = "  +string(controller.time.kg_per_year_to_units_per_sim_step(1))+" unit/sim step");
	show_debug_message("1 unit/step	    = "  +string(1/controller.time.kg_per_year_to_units_per_sim_step(1))+" kg/year");
	show_debug_message("-------------------------------------");
	show_debug_message("");
