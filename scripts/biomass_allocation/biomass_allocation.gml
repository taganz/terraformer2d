...
function biomass_allocation(_id) {
	...
	with _id.structure {
		...
		if biomass < biomass_adult_genome {
			...
			// - biomass reproduction = part of biomass over biomass_adult_genome * reproductive allocation
			// - biomass body = rest of biomass
			//			
		
			// -- biomass eat
			// 7/4/21  biomass_eat = biomass_adult_genome * _biomass_eat_allocation;		
			biomass_eat = biomass * _biomass_eat_allocation;		

			// -- biomass_reproduction
			//biomass_reproduction = 	biomass > biomass_adult_genome - _biomass_reproduction_max ? biomass - (biomass_adult_genome - _biomass_reproduction_max) : 0;
			biomass_reproduction = 	clamp(biomass - biomass_adult_genome, 0, _biomass_reproduction_max);
