...
//RD                  value = clamp((window_mouse_get_x() - bx1) / (bx2 - bx1) * (value_max - value_min) + value_min, value_min, value_max);
                    value = clamp((mouse_x - bx1) / (bx2 - bx1) * (value_max - value_min) + value_min, value_min, value_max);
                    if (_integers_only) {
                        value = round(value);
                    }
                    callback();
