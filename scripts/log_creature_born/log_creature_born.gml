function log_creature_born(_id){
	...
	with controller.species {
		...
		// first born for this genus?
		if genus_population[@ _id.genome[GEN.GENUS_ID]] == -1
			genus_population[@ _id.genome[GEN.GENUS_ID]] = 0;
			
		genus_population[@ _id.genome[GEN.GENUS_ID]]++;
	}
