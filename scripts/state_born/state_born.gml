...
//	_id.my_cell = controller.world.get_cell(_id.x, _id.y);
	...
	with _id.structure {
		...
		LOG(LOGEVENT.INFO_CREATURE, _id, "age: "+ string(controller.time.sim_steps_to_years(_id.structure.age))+"y");
		//LOG(LOGEVENT.INFO_CREATURE, _id, "age_adult: "+string(controller.time.sim_steps_to_years(age_adult))+"y ");
		LOG(LOGEVENT.INFO_CREATURE, _id, "age_die: "+string(controller.time.sim_steps_to_years(age_die))+"y ");
		...
		LOG(LOGEVENT.INFO_CREATURE, _id, "reproduction_interval: "+ string(controller.time.sim_steps_to_years(reproduction_interval))+"y");
